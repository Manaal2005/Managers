...
import com.example.managers.ui.theme.Brown
...
fun home(){
    Column(modifier = Modifier.fillMaxSize()) {
      ...
      var mysearch by remember { mutableStateOf("") }
        ...
        //Lottie Animation
        val composition by rememberLottieComposition(spec = LottieCompositionSpec.RawRes(R.raw.animate))
       ...
       Row {
           ...
           Button(onClick = { context.startActivity(Intent(context,productsActivity::class.java)) },
               colors = ButtonDefaults.buttonColors(Color.Red),
               shape = CutCornerShape(5.dp)
           ) {
